...
Status (2026-09-20): step 2 delivered (build number 6, full Xcode test run green 158/158; app launch crash from the iOS 27 SDK `cloudKitDatabase` default change fixed with explicit `.none`). Steps 3–9 open.
